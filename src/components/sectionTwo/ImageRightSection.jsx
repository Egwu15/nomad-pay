...
function ImageRightSection(props) {
  return (
    <div className="pt-24 pr-10 pl-10 md:p-24 flex flex-col sm:flex-row sm:space-y-2 md:flex md:space-x-4">
      <div className="w-full sm:w-1/2">
        <h2 className="text-dark-purple font-extrabold text-3xl pt-0 pr-0 md:pt-20 md:pr-20">
          {props.title}
        </h2>
        <p className="pt-5 md:pr-20 pr-0">{props.description}</p>
